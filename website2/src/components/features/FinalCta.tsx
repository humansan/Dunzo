...
import { ArrowRight, ArrowUp, CircleChevronRight, Sparkles } from 'lucide-react';
...
export const FinalCta: React.FC = () => (
  <section id="get-started" className="scroll-mt-28 py-24">
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
      <div className="inline-flex items-center gap-2 pl-2.5 pr-3.5 py-1.5 rounded-full bg-gold/15 text-xs font-semibold text-gold">
