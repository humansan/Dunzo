  ...
  return createPortal(
    <>
      ...
      <div
        ...
        className="z-[66] min-w-[190px] rounded-lg border border-white/10 bg-[#1f1f1f] shadow-2xl p-1 text-sm"
      >
        <div className="px-2.5 pt-1.5 pb-1 text-[11px] text-white/40 truncate">
          {email ?? 'Signed in'}
        </div>
