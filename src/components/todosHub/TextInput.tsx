...
export const inputBaseCls =
  'bg-overlay border border-fg/10 rounded-lg text-fg placeholder:text-fg/35 transition-colors focus:outline-none hover:border-fg/20 focus:border-[var(--accent2)]';
