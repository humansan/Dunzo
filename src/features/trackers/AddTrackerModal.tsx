  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        <OverlayShell
          onClose={onClose}
          panelClassName="relative w-full max-w-md bg-surface border border-line rounded-2xl shadow-2xl flex flex-col max-h-[90vh]"
        >
          {/* Sticky header */}
          <div className="flex justify-between items-center px-6 pt-5 pb-3 shrink-0">
            ...
            <button onClick={onClose} className={`rounded-lg p-1.5 transition-all ${btnGhost()}`}>
              <X size={16} />
            </button>
          </div>
